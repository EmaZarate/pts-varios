...
namespace Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Migrations
{
    ...
    [Migration("20190611141530_added-ac-model")]
    partial class addedacmodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionFishboneCauses", b =>
                {
                    ...
                    b.HasKey("CorrectiveActionID", "FishboneID", "CorrectiveActionFishboneCauseID");
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionFishboneCauseWhys", b =>
                {
                    ...
                    b.HasKey("CorrectiveActionID", "FishboneID", "CorrectiveActionFishboneCauseID", "CorrectiveActionFishboneCauseWhyID");
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActions", b =>
                {
                    ...
                    b.HasIndex("ResponisbleUserId");

                    b.HasIndex("ReviewerUserID");

                    b.HasIndex("PlantEmitterID", "SectorEmitterID");
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionTaskEvidences", b =>
                {
                    b.Property<int>("CorrectiveActionTaskEvidencesID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("CorrectiveActionID");

                    b.Property<int>("CorrectiveActionTaskID");

                    b.Property<string>("Name");

                    b.Property<string>("Url");

                    b.HasKey("CorrectiveActionTaskEvidencesID");

                    b.HasIndex("CorrectiveActionTaskID", "CorrectiveActionID");

                    b.ToTable("CorrectiveActionTaskEvidences");
                });

            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionTasks", b =>
                {
                    b.Property<int>("CorrectiveActionTaskID");
                    ...
                    b.HasKey("CorrectiveActionTaskID", "CorrectiveActionID");
                    ...
                    b.ToTable("CorrectiveActionTasks");
                });
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionFishboneCauseWhys", b =>
                {
                    b.HasOne("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionFishboneCauses", "CorrectiveActionFishboneCause")
                        ...
                        .HasForeignKey("CorrectiveActionID", "FishboneID", "CorrectiveActionFishboneCauseID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActions", b =>
                {
                    ...
                    b.HasOne("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Users", "ResponisbleUser")
                        .WithMany()
                        .HasForeignKey("ResponisbleUserId");

                    b.HasOne("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Users", "ReviewerUser")
                        .WithMany()
                        .HasForeignKey("ReviewerUserID");

                    b.HasOne("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.SectorsPlants", "SectorPlantEmitter")
                        .WithMany()
                        .HasForeignKey("PlantEmitterID", "SectorEmitterID");
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionTaskEvidences", b =>
                {
                    b.HasOne("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionTasks", "CorrectiveActionTask")
                        .WithMany("CorrectiveActionTaskEvidence")
                        .HasForeignKey("CorrectiveActionTaskID", "CorrectiveActionID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActionTasks", b =>
                {
                    b.HasOne("Hoshin.Core.Data.SQL.EntityFrameworkCoreDataAccess.SQLServer.Entities.Quality.CorrectiveActions", "CorrectiveAction")
                        .WithMany("CorrectiveActionTasks")
                        .HasForeignKey("CorrectiveActionID")
                        .OnDelete(DeleteBehavior.Cascade);
